<template>
  <div class="form-wrapper">
    ...
    <!-- <el-row v-show="receiveType == 1 && getCaseInfo.court.type != 2" :gutter="20" class="form-item">
      <el-col :span="5">
        <label>解纷组织</label>
      </el-col>
      <el-col :span="19">
...
export default {
  ...
  created() {
    ...
    this.getMediaterUser(this.getCaseInfo.court.id)
    this.getMediater()
  },
  mounted() {
  ...
  methods: {
    ...
    getMediater() {
      ...
      listCourtByCourId(params).then(res => {
        ...
        this.courtId = this.getCaseInfo.court.id
      })
    },
    selectCourt(e) {
